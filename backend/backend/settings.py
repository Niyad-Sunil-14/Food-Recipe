...
ALLOWED_HOSTS = ['food-recipe-backend-hntt.onrender.com','food-recipe-virid.vercel.app', '127.0.0.1']
...
SIMPLE_JWT = {
    ...
    'ROTATE_REFRESH_TOKENS': True,                 # Whether refresh tokens should be rotated
